...
class ListViewZonariesgo extends StatefulWidget {
  String nombre;
  ListViewZonariesgo(this.nombre);
  @override
  _ListViewZonariesgoState createState() => _ListViewZonariesgoState(nombre);
}
...
class _ListViewZonariesgoState extends State<ListViewZonariesgo> {
  String nombre;
  _ListViewZonariesgoState(this.nombre);
      ...
      home: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () => Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    ZonariesgoScreen(Zonariesgo(null, '', '', ''))),
          ),
        ),
      ),
    );
