...
class ListViewZonariesgo extends StatefulWidget {
  @override
  _ListViewZonariesgoState createState() => _ListViewZonariesgoState();
}

final zonariesgoReference = FirebaseDatabase.instance.reference().child('zonariesgo');

class _ListViewZonariesgoState extends State<ListViewZonariesgo> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        IconButton(
                            ...
                            onPressed: () => _navigateToZonariesgoInformation(
                                context, items[position])),
                      ],
                    ),
                  ],
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => ZonariesgoScreen(Zonariesgo(null, '', '', ''))),
          ),
        ),
      ),
    );
  ...
  void _navigateToZonariesgo(BuildContext context, Zonariesgo zonariesgo) async {
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => ZonariesgoInformation(zonariesgo)),
    );
  }
