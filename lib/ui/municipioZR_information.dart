...
class MunicipioZR_information extends StatefulWidget {
  final Municipio municipio;
  MunicipioZR_information(this.municipio);
  @override
  _MunicipioZonaRInformationState createState() => _MunicipioZonaRInformationState(municipio);
}

final zonariesgoReference =
FirebaseDatabase.instance.reference().child('zonariesgo');

class _MunicipioZonaRInformationState extends State<MunicipioZR_information> {
  final Municipio municipio;
  _MunicipioZonaRInformationState(this.municipio);
        ...
        body: Center(
          ...
          ListView.builder(
              ...
              itemBuilder: (context, position) {
                String str;
                str = widget.municipio.nombre;

          if (items[position].nombreMunicipio == str) {
                  return Column(
                    children: <Widget>[
                      Divider(
                        height: 7.0,
